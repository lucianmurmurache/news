    ...
    body = (
      <div className={classes.paper}>
        ...
        <Typography variant='body1' className={classes.trySaying}>
          Try saying: &quot;Give me the latest Business news&quot;
        </Typography>
        <Divider />
        <div className={classes.infoContainer}>
          <Typography variant='h5'>News by Terms</Typography>
          <div className={classes.chipContainer}>
            {['Climate change', 'Tesla', 'Deforestation', 'Animal rights'].map(
              (term, i) => (
                <Chip
                  key={i}
                  label={term}
        ...
        <div className={classes.infoContainer}>
          ...
          <div className={classes.chipContainer}>
            {['CNN', 'Wired', 'BBC News', 'Time'].map((source, i) => (
              <Chip
                key={i}
                label={source}
                color='primary'
        ...
        <Typography variant='body1' className={classes.trySaying}>
          Try saying: &quot;Get me the news from CNN&quot;
        </Typography>
      </div>
    );
  }
